...
public class PriceUtil {
     ...
     * @return 字符串
     */
    public static String formatWan(Long cent, int round) {
        if (cent == null) {
            return null;
        }
        BigDecimal bigDecimal = new BigDecimal(cent).divide(new BigDecimal(1000000));
        bigDecimal = bigDecimal.setScale(round, BigDecimal.ROUND_HALF_UP);
        return bigDecimal.toString();
    }
    ...
    public static long parseCentFromW(String w) {
        ...
        try {
            return (new BigDecimal(w).multiply(new BigDecimal(1000000))).longValue();
        } catch (Exception e) {
    ...
    public static long parseCentFromY(String w) {
        ...
        try {
            return (new BigDecimal(w).multiply(new BigDecimal(100))).longValue();
        } catch (Exception e) {
    ...
    public static String toRMB(long cent) {
        ...
        for (; i < len; i++, u++) {
            ...
            if (ch == '0') {
                ...
                resultBuf.append(DIGIT.charAt(ch - '0')).append(UNIT.charAt(u));
            }
        }
    ...
    public static Long formatCNTY(Long cent) {
        if (cent == null) {
            return null;
        }
        if (cent < 0l) {
